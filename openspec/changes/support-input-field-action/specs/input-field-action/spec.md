...
- 相关功能：`src/parser/intents.py` - 意图类型定义
- 相关功能：`src/parser/command_parser.py` - 命令解析
- 相关功能：`config/operations/pycharm.yaml` - 操作配置
- 相关功能：`src/locator/visual_locator.py` - 视觉定位
- 相关功能：`src/automation/executor.py` - 操作执行
